...
async function startGame() {
    ...
    while(gameState != "gameOver") {
        ...
        switch(gameState) {
            case "deal" : await dealCards(); break;
            case "pickOrPass" : await pickOrPass(); break;
            case "pickSuit" :  pickSuit(); break;
            case "discard" : discard(); break;
            case "playHand" :  playHand(); break;
            default : gameState="gameOver";
        }
    }
}
function dealCards() {
